...
#### Creating a JoinTable Migration
This should be used if you need only a table that has the ids of either record

    $ bin/rails g migration CreateJoinTable<Table1><Table2> <lowercase_table1> <lowercase_table2>

    #Migration should like
    ...
    # Inside the associated models add the following
    ...
    # FYI, the table name is names table1plural_table2plural

#### Performing an Association w/ a joined table
    table1_instance.pluraltable2 << Table2.find_by(some_attr: "Some String")

#### Has Many Through
Should be used when you have a model that has attributes that connect it to two other models

    # In this example Magazine and Subscriber both have their ids stored in Subscription
...
#### Destroy migrations
    $ bin/rails destroy migration <MigrationName>
...
We have a post with many comments
    ...
    post.comments.create(content: "Cool")
